...
import type { PlantsApiResponse, PlantFilters } from "../../types/public/plant.types";

/**
 * Helper hook untuk mendapatkan lebar window.
 */
...
export const usePlantsPage = () => {
    ...
    const handleFilterChange = useCallback(
        (filterType: keyof PlantFilters, value: string | number) => {
