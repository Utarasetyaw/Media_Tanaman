				...
				<div className="w-full mx-auto px-4 sm:px-6 lg:px-8 2xl:px-60 py-12 sm:py-16">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
						...
						<div className="lg:sticky lg:top-24 h-fit">
							{/* PERBAIKAN: Mengubah rasio gambar menjadi 16:9 (widescreen) */}
						...
						<div className="flex flex-col">
							...
							<div className="space-y-6">
								{/* Bagian Toko Online */}
								{plant.stores?.online && plant.stores.online.length > 0 && (
									<div>
								...
								{/* Bagian Toko Offline */}
								{plant.stores?.offline && plant.stores.offline.length > 0 && (
									<div>
										<h3 className="flex items-center gap-2 font-semibold text-gray-200 mb-3">
											<MapPin
												size={18}
										...
										<div className="space-y-3">
											{plant.stores.offline.map((store) => (
												<div
													key={store.name}
