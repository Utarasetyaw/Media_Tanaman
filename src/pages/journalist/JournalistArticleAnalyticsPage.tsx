                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div>
                         ...
                         {/* <div className="sticky top-24">
                            <Link to={`/articles/${article.id}`} target="_blank" rel="noopener noreferrer" className="w-full bg-lime-400 text-gray-900 font-bold py-3 px-4 rounded-lg hover:bg-lime-500 flex items-center justify-center gap-2 transition-colors">
