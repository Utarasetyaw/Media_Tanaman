...
// ▼▼▼ Menambahkan 'ThumbsUp' dan menghapus 'Heart', 'Eye' ▼▼▼
...
//================================================================================
// KOMPONEN ArticleCard DENGAN GAYA BARU SESUAI REFERENSI
//================================================================================
...
const ArticleCard: FC<ArticleCardProps> = ({ article, lang, t }) => {
	...
	// Fungsi formatCount tidak lagi digunakan, dihapus.
		...
		<div className="bg-[#004A49]/60 border-2 border-lime-400/50 rounded-lg shadow-lg overflow-hidden group transition-all duration-300 hover:shadow-lime-400/20 hover:-translate-y-1 flex flex-col h-full">
			...
			<div className="p-4 sm:p-6 flex flex-col flex-grow">
				<div className="flex-grow">
					...
					{/* ▼▼▼ Bagian Statistik Diperbarui Sesuai Referensi ▼▼▼ */}
...
//================================================================================
// KOMPONEN UTAMA: ArticleDetail (Tidak ada perubahan logika)
//================================================================================
