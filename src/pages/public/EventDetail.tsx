...
const EventDetail: FC = () => {
	...
	const { event, isLoading, isError, handleExternalLinkClick } =
		useEventDetail();

	if (isLoading) {
		return (
			<div className="bg-[#003938] min-h-screen text-center py-20 text-white">
	...
	// --- REVISI: Logika tanggal dan waktu dibuat lebih jelas ---
	...
	const buttonClassName =
		"mt-6 w-full text-center inline-block bg-lime-300 text-lime-900 font-bold py-3 px-6 rounded-lg hover:bg-lime-400 transition-colors duration-300";

	return (
		<>
			{/* REVISI: Tambahkan SeoManager untuk SEO yang lebih baik */}
			<SeoManager
				...
				<div className="w-full mx-auto px-4 sm:px-6 lg:px-8 2xl:px-60 py-12 sm:py-16">
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-12">
						<div className="lg:col-span-2">
							<div className="aspect-video lg:hidden mb-6 bg-black/20 rounded-2xl overflow-hidden border-2 border-lime-400/50">
								<img
									src={event.imageUrl}
							...
							<h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-8">
								{event.title[currentLang]}
							</h1>
							<h2 className="font-serif text-2xl font-bold text-lime-400 mb-4 border-b-2 border-lime-400/50 pb-4">
								{t("description_title")}
							</h2>
							<div
								className="prose prose-invert prose-sm sm:prose-base max-w-none text-gray-300 leading-relaxed whitespace-pre-line"
								dangerouslySetInnerHTML={{
									__html: event.description[currentLang],
								}}
							/>
						</div>
						...
						<div className="lg:col-span-1 mt-12 lg:mt-0">
							<div className="lg:sticky lg:top-24">
								<div className="aspect-video hidden lg:block mb-6 bg-black/20 rounded-2xl overflow-hidden border-2 border-lime-400/50">
									<img
										src={event.imageUrl}
										alt={event.title[currentLang]}
										className="w-full h-full object-cover shadow-lg"
